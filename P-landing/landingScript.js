...
document.addEventListener("click", function(event) {
    const itemType = Math.random() > 0.8 ? "video" : "image";
    ...
    if(itemType === "video" ){
        ...
        container.innerHTML = `<div class="video-container">
                                    <video autoplay loop muted>
                                        <source src="./videos/activeVideos/video${videoNumber}.mp4" type="video/mp4" />
                                    </video>
                                </div>`;

    } else {
        const imgNumber = Math.floor(Math.random()*93)+1;
        container.innerHTML = `<div class="img-container">
                                    <img src="./images/activeImages/img${imgNumber}.jpg" alt="" />
                                </div>`;
    ...
    document.querySelector(".item-container").appendChild(appendedElement);
